...
class MainWindow(QMainWindow):
	...
	def eventFilter(self, obj, e):
		try:
			...
			###########################################################
				...
				self.ui.settings_lang_title.setText('भाषा: हिन्दी')
				self.ui.settings_lang_eng_icon.hide()
			...
			###########################################################
				...
				if lang == False:
					self.notify = Notify(text="<b>मुझे आपका कंप्यूटर और उस पर संग्रहीत डेटा बहुत पसंद है</b>")
	...
	def change_lang_rus(self):
		...
		####################################################
		self.ui.scanning_choose_btn_full.setText("भरा हुआ")
		self.ui.scanning_choose_btn_folder.setText("फ़ोल्डर")
		self.ui.scanning_choose_btn_file.setText("फ़ाइल")
		self.ui.scanning_start_btn.setText("स्कैन")
		...
		self.ui.faq_small_description_text.setText("<html><head/><body><p>CyberAegXs Security - это начинающий проект, который быстро набирает обороты.  У нас есть довольно большая база данных вирусов, в количестве 30 миллионов, а также наш собственный искусственный интеллект, который может обнаружить любое вредоносное ПО.</p></body></html>")
		...
		##==> НАСТРОЙКИ
		####################################################
		self.ui.settings_lang_rus_title.setText("Hindi")
	...
	def change_lang_eng(self):
		...
		self.ui.faq_small_description_text.setText("<html><head/><body><p>CyberAegXs Security is a start-up project that is rapidly gaining momentum.  We have a fairly large database of viruses, in the amount of 30 million, as well as our own artificial intelligence that can detect any malware.</p></body></html>")
...
class SystemTrayIcon(QtWidgets.QSystemTrayIcon):
	...
	def __init__(self, icon, parent=None):
		...
		self.setToolTip(f'CyberAegXs Security')
